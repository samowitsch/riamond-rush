...
# delete zip archive
echo "$(timestamp): delete old zip file for clay.io"
rm riamond-rush-clay.zip

#zipping needed files for clay.io
zip -rq riamond-rush-clay.zip clayio.html gfx/ css/ js/ sfx/ font/ effects/
echo "$(timestamp): zipped file for clay.io"
